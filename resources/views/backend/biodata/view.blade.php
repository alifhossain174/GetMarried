        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body pb-4">
                    <h4 class="mb-3 header-title mt-0">View All Biodatas</h4>
                    ...
                    <table class="table table-sm table-striped table-bordered table-hover yajra-datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Marrital Condition</th>
                                <th class="text-center">Birth Date</th>
                                <th class="text-center">Height</th>
                                <th class="text-center">Skin Tone</th>
                                <th class="text-center">Permenant Address</th>
    ...
    <script>
        var table = $('.yajra-datatable').DataTable({
            ...
            columns: [
                ...
                {data: 'biodata_no', name: 'biodata_no'},
                {data: 'name', name: 'name'},
                {data: 'biodata_type', name: 'biodata_type'},
                {data: 'marital_condition', name: 'marital_condition'},
                {data: 'birth_date', name: 'birth_date'},
                {data: 'height_foot', name: 'height_foot'},
                {data: 'height_foot', name: 'height_foot'},
