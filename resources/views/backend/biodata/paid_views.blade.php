    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Biodata Paid Views</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Functional Module</a></li>
                        <li class="breadcrumb-item active">Biodata Paid Views</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body pb-4">
                    <h4 class="mb-3 header-title mt-0">View All Biodata Paid Views</h4>
                    ...
                    <table class="table table-sm table-striped table-bordered table-hover yajra-datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Purchased By (Name)</th>
                                <th class="text-center">Purchased By (Contact)</th>
...
@section('footer_js')
    ...
    <script>
        var table = $('.yajra-datatable').DataTable({
            ...
            ajax: "{{ url('view/biodata/paid/views') }}",
            columns: [{
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
                },
