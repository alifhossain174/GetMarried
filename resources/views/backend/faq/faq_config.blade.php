        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body pb-4">
                    <h4 class="mb-3 header-title mt-0">Update Faq Config</h4>

                    <form class="form-horizontal" action="{{ url('update/faq/config') }}" method="POST" enctype="multipart/form-data">
                        @csrf
