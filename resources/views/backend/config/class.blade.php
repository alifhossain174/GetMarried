        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body pb-4">
                    <h4 class="mb-3 header-title mt-0">View All Classes</h4>

                    <label id="customFilter" style="float: right;">
                        <button class="btn btn-success btn-sm" id="addNewPricing" style="margin-left: 10px"><b><i class="bi bi-plus-lg"></i> Add New Class</b></button>
                        <a href="{{url('rearrange/class')}}" class="btn btn-success btn-sm" style="margin-left: 5px"><b><i class="bi bi-shuffle"></i> Rearrange Class</b></a>
                    </label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="productForm" name="productForm" class="form-horizontal">
                        ...
                        <div class="form-group mb-1">
                            <label for="name" class="col-form-label">Class Name (Bangla)</label>
...
@section('footer_js')
    ...
    <script>
        ...
        $('#addNewPricing').click(function() {
            ...
            $("#class_id").val(0);
            $("#exampleModalLabel").html("Add New Class");
            ...
            if(classId > 0){ // update
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        toastr.success("Class Info Updated", "Updated Successfully");
                        table.draw(false);
                    },
                    error: function (data) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#productForm').trigger("reset");
                        $('#exampleModal').modal('hide');
                        toastr.success("New Class Added", "Added Successfully");
                        table.draw(false);
                    },
                    error: function (data) {
                        console.log('Error:', data);
        ...
        $('body').on('click', '.editBtn', function () {
            ...
            $.get("{{ url('get/class/info') }}" +'/' + slug, function (data) {
                $("#exampleModalLabel").html("Update Class Info");
                $('#exampleModal').modal('show');
