    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">School Shifts</h4>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body pb-4">
                    <h4 class="mb-3 header-title mt-0">View All Shifts</h4>

                    <label id="customFilter" style="float: right;">
                        <button class="btn btn-success btn-sm" id="addNewPricing" style="margin-left: 10px"><b><i class="bi bi-plus-lg"></i> Add New Shift</b></button>
                        <a href="{{url('rearrange/shift')}}" class="btn btn-success btn-sm" style="margin-left: 5px"><b><i class="bi bi-shuffle"></i> Rearrange Shift</b></a>
                    </label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="productForm" name="productForm" class="form-horizontal">
                        ...
                        <div class="form-group mb-1">
                            <label for="name" class="col-form-label">Shift Name (Bangla)</label>
                            <input type="text" class="form-control" id="bn_name" name="bn_name">
                        </div>

                        <div class="form-group mb-1">
                            <label class="col-form-label">Status</label>
                            <select class="form-select" id="shift_status" name="status">
...
@section('footer_js')
    ...
    <script>
        ...
        $('#addNewPricing').click(function() {
            ...
            $("#shift_id").val(0);
            $("#exampleModalLabel").html("Add New Shift");
            ...
            if(shiftId > 0){ // update
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        toastr.success("Shift Info Updated", "Updated Successfully");
                        table.draw(false);
                    },
                    error: function (data) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('#productForm').trigger("reset");
                        $('#exampleModal').modal('hide');
                        toastr.success("New Shift Added", "Added Successfully");
                        table.draw(false);
                    },
                    error: function (data) {
                        console.log('Error:', data);
        ...
        $('body').on('click', '.editBtn', function () {
            ...
            $.get("{{ url('get/shift/info') }}" +'/' + slug, function (data) {
                $("#exampleModalLabel").html("Update Shift Info");
                $('#exampleModal').modal('show');
                $('#shift_id').val(data.id);
                $('#name').val(data.name);
                $('#bn_name').val(data.bn_name);
                $('#shift_status').val(data.status);
            })
        });
