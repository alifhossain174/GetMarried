...
@section('header_css')
    ...
    <style>
        ...
        table.dataTable tbody td:nth-child(2), td:nth-child(3){
            text-align: center !important;
        }
        ...
        table.dataTable tbody td:nth-child(5), td:nth-child(6){
            text-align: center !important;
        }
    </style>
@endsection
            ...
            <div class="page-title-box">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">View All User Roles</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body pb-4">
                    <h4 class="mb-3 header-title mt-0">View All User Roles</h4>
