                ...
                <div class="card-body pb-4">
                    ...
                    <form class="form-horizontal" action="{{ url('update/how/it/works') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10 col-md-10">
                                <input type="text" name="description" value="{{$data->description}}" class="form-control @error('description') is-invalid @enderror" id="description" placeholder="You can easily create a biodata in Sadikrun for free.">
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10 col-md-10">
                                <input type="text" name="description_bn" value="{{$data->description_bn}}" class="form-control @error('description_bn') is-invalid @enderror" id="description_bn" placeholder="খুব সহজেই বিনামূল্যে সাদিকরুনে বায়োডাটা তৈরি করতে পারবেন।">
