    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Homepage Statistics Config</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Website Content Modules</a></li>
                        <li class="breadcrumb-item active">Homepage Statistics Config</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body pb-4">
                    <h4 class="mb-3 header-title mt-0">Update Homepage Statistics Config</h4>

                    <form class="form-horizontal" action="{{ url('update/homepage/statistics/config') }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="row mb-3">
                            <label for="section_title" class="col-lg-2 col-md-2 col-form-label">Section Title</label>
                            <div class="col-lg-10 col-md-10">
                                <input type="text" name="section_title" value="{{$data->section_title}}" class="form-control @error('section_title') is-invalid @enderror" id="section_title" placeholder="Statistics of Service Taker">
                                @error('section_title')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10 col-md-10">
                                <input type="text" name="section_title_bn" value="{{$data->section_title_bn}}" class="form-control @error('section_title_bn') is-invalid @enderror" id="section_title_bn" placeholder="সেবা গ্রহীতার পরিসংখ্যান ">
