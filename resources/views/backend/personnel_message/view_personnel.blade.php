    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">View Personnels</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Content Module</a></li>
                        <li class="breadcrumb-item active">View Personnels</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body pb-4">
                    <h4 class="mb-3 header-title mt-0">View All Personnels</h4>

                    <label id="customFilter" style="float: right;">
                        <a href="{{url('rearrange/personnels')}}" class="btn btn-success btn-sm" style="margin-left: 5px"><b><i class="bi bi-shuffle"></i> Rearrange Personnels</b></a>
                    </label>
                    ...
                    <table class="table table-sm table-striped table-bordered table-hover yajra-datatable">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Designated Title</th>
    ...
    <script>
        var table = $('.yajra-datatable').DataTable({
            ...
            columns: [
                ...
                {data: 'name', name: 'name'},
                {data: 'designated_title', name: 'designated_title'},
