    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">View Instructions</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Content Modules</a></li>
                        <li class="breadcrumb-item active">View Instructions</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body pb-4">
                    <h4 class="mb-3 header-title mt-0">View All View Instructions</h4>

                    <label id="customFilter" style="float: right;">
                        <a href="{{url('rearrange/instructions')}}" class="btn btn-success btn-sm" style="margin-left: 5px"><b><i class="bi bi-shuffle"></i> Rearrange Items</b></a>
                    </label>
...
@section('footer_js')
    ...
    <script>
        var table = $('.yajra-datatable').DataTable({
            ...
            ajax: "{{ url('view/all/instructions') }}",
            columns: [
    ...
    <script>
        ...
        $('body').on('click', '.deleteBtn', function () {
            ...
            if(confirm("Are You sure want to delete !")){
                $.ajax({
                    type: "GET",
                    url: "{{ url('delete/instruction') }}"+'/'+slug,
