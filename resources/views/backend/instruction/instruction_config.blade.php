    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Instruction Config</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Website Content Modules</a></li>
                        <li class="breadcrumb-item active">Instruction Config</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body pb-4">
                    <h4 class="mb-3 header-title mt-0">Update Instruction Config</h4>

                    <form class="form-horizontal" action="{{ url('update/instruction/config') }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="row mb-3">
                            <label for="page_title" class="col-lg-2 col-md-2 col-form-label">Page Title</label>
                            <div class="col-lg-10 col-md-10">
                                <input type="text" name="page_title" value="{{$data->page_title}}" class="form-control @error('page_title') is-invalid @enderror" id="page_title" placeholder="Page Title">
                                @error('page_title')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10 col-md-10">
                                <input type="text" name="page_title_bn" value="{{$data->page_title_bn}}" class="form-control @error('page_title_bn') is-invalid @enderror" id="page_title_bn" placeholder="Page Title (BN)">
                                @error('page_title_bn')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
