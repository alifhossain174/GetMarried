    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">Rearrange Instructions</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">Website Content Module</a></li>
                        <li class="breadcrumb-item active">Rearrange Instructions</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body pb-4">
                    ...
                    <form action="{{url('save/rearranged/instructions')}}" method="POST" enctype="multipart/form-data">
                        @csrf
