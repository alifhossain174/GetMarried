            ...
            <div class="page-title-box">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Add New Instruction</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body pb-4">
                    <h4 class="mb-3 header-title mt-0">Add Instruction</h4>

                    <form class="form-horizontal" action="{{ url('save/instruction') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10 col-md-10">
                                <input type="text" name="question_bn" class="form-control @error('question_bn') is-invalid @enderror" id="question_bn" placeholder="Question in Bangla">
                                @error('question_bn')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10 col-md-10">
                                <textarea id="answer_bn" name="answer_bn"></textarea>
                            </div>
                        </div>
