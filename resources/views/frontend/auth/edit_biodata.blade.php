                                    ...
                                    <div class="user-d-edit-biodata-tab-menu">
                                        <div class="list-group" id="list-tab" role="tablist">
                                            <a class="list-group-item active" data-bs-toggle="list" href="#tab1"
                                                id="tabButton1" role="tab">
                                                <span>1</span>
                                                {{ __('label.general_info') }}
                                            </a>
                                            <a class="list-group-item" data-bs-toggle="list" href="#tab2" id="tabButton2"
                                                role="tab">
                                                <span>2</span>
                                                {{ __('label.address') }}
                                            </a>
                                            ...
                                            <a class="list-group-item" data-bs-toggle="list" href="#tab{{ $sl }}"
                                                id="tabButton{{ $sl }}" role="tab">
                                                <span>10</span>
                                                {{ __('label.contact') }}
                                            </a>
                                        </div>
                                        ...
                                        <div class="tab-content" id="nav-tabContent">
                                                        ...
                                                        <form action="" method="">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="select2 hero-search-filter-select"
                                                                    id="biodata_type_id" name="biodata_type_id" required>
                                                                    <option value="">
                                                                        {{ __('label.form_biodata_report_select_option') }}
                                                                    </option>
                                                                    @foreach ($biodataTypes as $type)
                                                                        <option value="{{ $type->id }}"
                                                                            @if ($biodata && $biodata->biodata_type_id == $type->id) selected @endif>
                                                                            {{ App::currentLocale() == 'en' ? $type->title : $type->title_bn }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <select class="select2 hero-search-filter-select"
                                                                    id="marital_condition_id" name="marital_condition_id"
                                                                    required>
                                                                    <option value="">
                                                                        {{ __('label.form_biodata_report_select_option') }}
                                                                    </option>
                                                                    @foreach ($maritalConditions as $condition)
                                                                        <option value="{{ $condition->id }}"
                                                                            @if ($biodata && $biodata->marital_condition_id == $condition->id) selected @endif>
                                                                            {{ App::currentLocale() == 'en' ? $condition->title : $condition->title_bn }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <input type="date" id="birth_date" name="birth_date"
                                                                    value="{{ $biodata ? $biodata->birth_date : '' }}"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-6">
                                                                        <select class="select2 hero-search-filter-select"
                                                                            id="height_foot" name="height_foot" required>
                                                                            <option value="">
                                                                                {{ __('label.form_biodata_report_select_option') }}
                                                                            </option>
                                                                            <option value="2"
                                                                                @if ($biodata && $biodata->height_foot == 2) selected @endif>
                                                                                2′</option>
                                                                            <option value="3"
                                                                                @if ($biodata && $biodata->height_foot == 3) selected @endif>
                                                                                3′</option>
                                                                            <option value="4"
                                                                                @if ($biodata && $biodata->height_foot == 4) selected @endif>
                                                                                4′</option>
                                                                            <option value="5"
                                                                                @if ($biodata && $biodata->height_foot == 5) selected @endif>
                                                                                5′</option>
                                                                            <option value="6"
                                                                                @if ($biodata && $biodata->height_foot == 6) selected @endif>
                                                                                6′</option>
                                                                            <option value="7"
                                                                                @if ($biodata && $biodata->height_foot == 7) selected @endif>
                                                                                7′</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="col-6">
                                                                        <select class="select2 hero-search-filter-select"
                                                                            id="height_inch" name="height_inch" required>
                                                                            <option value="">
                                                                                {{ __('label.form_biodata_report_select_option') }}
                                                                            </option>
                                                                            <option value="1"
                                                                                @if ($biodata && $biodata->height_inch == 1) selected @endif>
                                                                                1″</option>
                                                                            <option value="2"
                                                                                @if ($biodata && $biodata->height_inch == 2) selected @endif>
                                                                                2″</option>
                                                                            <option value="3"
                                                                                @if ($biodata && $biodata->height_inch == 3) selected @endif>
                                                                                3″</option>
                                                                            <option value="4"
                                                                                @if ($biodata && $biodata->height_inch == 4) selected @endif>
                                                                                4″</option>
                                                                            <option value="5"
                                                                                @if ($biodata && $biodata->height_inch == 5) selected @endif>
                                                                                5″</option>
                                                                            <option value="6"
                                                                                @if ($biodata && $biodata->height_inch == 6) selected @endif>
                                                                                6″</option>
                                                                            <option value="7"
                                                                                @if ($biodata && $biodata->height_inch == 7) selected @endif>
                                                                                7″</option>
                                                                            <option value="8"
                                                                                @if ($biodata && $biodata->height_inch == 8) selected @endif>
                                                                                8″</option>
                                                                            <option value="9"
                                                                                @if ($biodata && $biodata->height_inch == 9) selected @endif>
                                                                                9″</option>
                                                                            <option value="10"
                                                                                @if ($biodata && $biodata->height_inch == 10) selected @endif>
                                                                                10″</option>
                                                                            <option value="11"
                                                                                @if ($biodata && $biodata->height_inch == 11) selected @endif>
                                                                                11″</option>
                                                                            <option value="12"
                                                                                @if ($biodata && $biodata->height_inch == 12) selected @endif>
                                                                                12″</option>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="select2 hero-search-filter-select"
                                                                    id="skin_tone" name="skin_tone" required>
                                                                    <option value="">
                                                                        {{ __('label.form_biodata_report_select_option') }}
                                                                    </option>
                                                                    <option value="1"
                                                                        @if ($biodata && $biodata->skin_tone == 1) selected @endif>
                                                                        {{ __('label.skin_tone_black') }}</option>
                                                                    <option value="2"
                                                                        @if ($biodata && $biodata->skin_tone == 2) selected @endif>
                                                                        {{ __('label.skin_tone_brown') }}</option>
                                                                    <option value="3"
                                                                        @if ($biodata && $biodata->skin_tone == 3) selected @endif>
                                                                        {{ __('label.skin_tone_bright_brown') }}</option>
                                                                    <option value="4"
                                                                        @if ($biodata && $biodata->skin_tone == 4) selected @endif>
                                                                        {{ __('label.skin_tone_white') }}</option>
                                                                    <option value="5"
                                                                        @if ($biodata && $biodata->skin_tone == 5) selected @endif>
                                                                        {{ __('label.skin_tone_bright_white') }}</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="select2 hero-search-filter-select"
                                                                    ...
                                                                    <option value="1"
                                                                        @if ($biodata && $biodata->blood_group == 1) selected @endif>
                                                                        A+</option>
                                                                    <option value="2"
                                                                        @if ($biodata && $biodata->blood_group == 2) selected @endif>
                                                                        A-</option>
                                                                    <option value="3"
                                                                        @if ($biodata && $biodata->blood_group == 3) selected @endif>
                                                                        B+</option>
                                                                    <option value="4"
                                                                        @if ($biodata && $biodata->blood_group == 4) selected @endif>
                                                                        B-</option>
                                                                    <option value="5"
                                                                        @if ($biodata && $biodata->blood_group == 5) selected @endif>
                                                                        AB+</option>
                                                                    <option value="6"
                                                                        @if ($biodata && $biodata->blood_group == 6) selected @endif>
                                                                        AB-</option>
                                                                    <option value="7"
                                                                        @if ($biodata && $biodata->blood_group == 7) selected @endif>
                                                                        O+</option>
                                                                    <option value="8"
                                                                        @if ($biodata && $biodata->blood_group == 8) selected @endif>
                                                                        O-</option>
                                                                    <option value="9"
                                                                        @if ($biodata && $biodata->blood_group == 9) selected @endif>
                                                                        {{ __('label.dont_know') }}</option>
                                                                </select>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <select class="select2 hero-search-filter-select"
                                                                    ...
                                                                    @foreach ($nationalities as $nationality)
                                                                        <option value="{{ $nationality->id }}"
                                                                            @if ($biodata && $biodata->nationality == $nationality->id) selected @endif>
                                                            ...
                                                            <div class="user-d-edit-biodata-form-button"
                                                                ...
                                                                <button type="button" onclick="saveGeneralInfo()"
                                                                    class="theme-btn">
                                                                    <img id="loader"
                                                                        src="{{ url('frontend_assets') }}/assets/images/loader.gif"
                                                                        style="display:none; width: 20px; margin-right: 5px;">Save
                                                                    & Next
                                                                </button>
                                                            </div>
                                            ...
                                            <div class="tab-pane fade" id="tab2" role="tabpanel">
                                                <form action="" method="">
                                                        ...
                                                        <div class="edit-biodata-form-data">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="hero-search-filter-select select2"
                                                                    name="permenant_district_id"
                                                                    id="permenant_district_id" required>
                                                                    <option value="">
                                                                        {{ __('label.hero_all_district') }}</option>
                                                                    @foreach ($districts as $district)
                                                                        <option value="{{ $district->id }}"
                                                                            @if ($biodata && $biodata->permenant_district_id == $district->id) selected @endif>
                                                                            {{ App::currentLocale() == 'en' ? $district->name : $district->bn_name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                                                    ...
                                                                    @if ($biodata && $biodata->permenant_upazila_id > 0 && $biodata->permenant_district_id > 0)
                                                                        @php
                                                                            $permenantUpazilas = DB::table('upazilas')
                                                                                ->where('district_id', $biodata->permenant_district_id)
                                                                                ->get();
                                                                        @endphp
                                                                        @foreach ($permenantUpazilas as $upazila)
                                                                            <option value="{{ $upazila->id }}"
                                                                                @if ($biodata->permenant_upazila_id == $upazila->id) selected @endif>
                                                                                {{ App::currentLocale() == 'en' ? $upazila->name : $upazila->bn_name }}
                                                                            </option>
                                                                        @endforeach
                                                                    @endif
                                                                </select>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="permenant_address"
                                                                    id="permenant_address"
                                                                    value="{{ $biodata ? $biodata->permenant_address : '' }}"
                                                                    required />
                                                    ...
                                                    <div class="edit-biodata-form-widget" style="margin-top: 24px">
                                                        ...
                                                        <div class="edit-biodata-form-data">
                                                            <div class="form-group">
                                                                <label>{{ __('label.district') }}<span>*</span></label>
                                                                <select class="hero-search-filter-select select2"
                                                                    name="present_district_id" id="present_district_id"
                                                                    required>
                                                                    <option value="">
                                                                        {{ __('label.hero_all_district') }}</option>
                                                                    @foreach ($districts as $district)
                                                                        <option value="{{ $district->id }}"
                                                                            @if ($biodata && $biodata->present_district_id == $district->id) selected @endif>
                                                                            {{ App::currentLocale() == 'en' ? $district->name : $district->bn_name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                                    ...
                                                                    @if ($biodata && $biodata->present_upazila_id > 0 && $biodata->present_district_id > 0)
                                                                        @php
                                                                            $presentUpazilas = DB::table('upazilas')
                                                                                ->where('district_id', $biodata->present_district_id)
                                                                                ->get();
                                                                        @endphp
                                                                        @foreach ($presentUpazilas as $upazila)
                                                                            <option value="{{ $upazila->id }}"
                                                                                @if ($biodata->present_upazila_id == $upazila->id) selected @endif>
                                                                                {{ App::currentLocale() == 'en' ? $upazila->name : $upazila->bn_name }}
                                                                            </option>
                                                                        @endforeach
                                                                    @endif
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="present_address"
                                                                    id="present_address"
                                                                    value="{{ $biodata ? $biodata->present_address : '' }}"
                                                                    required />
                                                                <p>{{ __('label.area_name_hints') }}</p>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="user-d-edit-biodata-form-button">
                                                        <button type="button" onclick="goToPrevTab(2)"
                                                            class="theme-btn secondary">Back</button>
                                            ...
                                            @foreach ($questionSets as $set)
                                                ...
                                                <div class="tab-pane fade" id="tab{{ $sl }}" role="tabpanel">
                                                    <div class="edit-biodata-form-widget">
                                                        ...
                                                        <div class="edit-biodata-form-data">
                                                            <form id="productForm{{ $sl }}"
                                                                name="productForm{{ $sl }}" action=""
                                                                method="">
                                                                @foreach ($questions as $question)
                                                                    @php
                                                                        if ($question->type == 2) {
                                                                            $options = DB::table('m_c_q_s')
                                                                    ...
                                                                    @endphp
                                                                    <input type="hidden" name="question_set_id[]"
                                                                        value="{{ $set->id }}">
                                                                    <div class="form-group">
                                                                        <label>{{ App::currentLocale() == 'en' ? $question->question : $question->question_bn }}
                                                                        ...
                                                                        @elseif($question->type == 2)
                                                                            <select
                                                                                class="hero-search-filter-select select2 answer"
                                                                                name="answer[]"
                                                                                ...
                                                                                @foreach ($options as $option)
                                                                                    <option value="{{ $option->id }}"
                                                                                        @if ($questionAnswer && $questionAnswer->answer == $option->id) selected @endif>
                                                                                        {{ App::currentLocale() == 'en' ? $option->option : $option->option_bn }}
                                                                                    </option>
                                                                                @endforeach
                                                                            </select>
                                                                        @else
                                                                        ...
                                                                        @if ($question->required)
                                                                            <p>{{ App::currentLocale() == 'en' ? $question->hints : $question->hints_bn }}
                                                                            </p>
                                                                        @endif
                                                                ...
                                                                <div class="user-d-edit-biodata-form-button">
                                                                    <button type="button"
                                                                        onclick="goToPrevTab({{ $sl }})"
                                                                        class="theme-btn secondary">Back</button>
                                                                    <button type="button"
                                                                        onclick="saveBioDataInfo({{ $sl }})"
                                                                        class="theme-btn">
                                                                        <img id="loader{{ $sl }}"
                                                                            src="{{ url('frontend_assets') }}/assets/images/loader.gif"
                                                                            style="display:none; width: 20px; margin-right: 5px;">
                                                                        Save & Next
                                                                    </button>
                                                                </div>
                                                        ...
                                                        <form action="" method="">
                                                                ...
                                                                <div class="upload-img-input">
                                                                    <div class="library-photo-input">
                                                                        ...
                                                                        <label for="library-photo-input">
                                                                            <i class="fi fi-rr-upload"></i> <span>Upload
                                                                                photo</span>
                                                                        </label>
                                                                    </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="tel" name="gurdians_mobile_no"
                                                                    id="gurdians_mobile_no"
                                                                    value="{{ $biodata ? $biodata->gurdians_mobile_no : '' }}"
                                                                    placeholder="01700-000000" required />
                                                                <p>{{ __('label.gurdians_contact_hints') }}</p>
                                                            </div>
                                                            <div class="form-group">
                                                                <label>{{ __('label.relation_with_girdian') }}<span>*</span></label>
                                                                <input type="text" name="relation_with_gurdian"
                                                                    id="relation_with_gurdian"
                                                                    value="{{ $biodata ? $biodata->relation_with_gurdian : '' }}"
                                                            ...
                                                            <div class="user-d-edit-biodata-form-button">
                                                                <button type="button"
                                                                    ...
                                                                    class="theme-btn secondary">Back</button>
                                                                <button type="button"
                                                                    onclick="saveContactInfo({{ $sl }})"
                                                                    class="theme-btn">
                                                                    <img id="loader{{ $sl }}"
                                                                        src="{{ url('frontend_assets') }}/assets/images/loader.gif"
                                                                        style="display:none; width: 20px; margin-right: 5px;">Submit
                                                                    Biodata
                                                                </button>
                                                            </div>
...
@section('footer_js')
    <script>
        ...
        function saveGeneralInfo() {
            ...
            if (!$("#biodata_type_id").val() || !$("#marital_condition_id").val() || !$("#birth_date").val() || !$(
                    "#height_foot").val() || !$("#height_inch").val() || !$("#skin_tone").val() || !$("#weight").val() || !
                $("#blood_group").val() || !$("#nationality").val()) {
        ...
        function saveAddress() {
            ...
            if (!$("#permenant_district_id").val() || !$("#permenant_upazila_id").val() || !$("#permenant_address").val() ||
                !$("#present_district_id").val() || !$("#present_upazila_id").val() || !$("#present_address").val()) {
                toastr.error("Please fill up the required fields", "Failed to Save Info");
                return false;
            }
        ...
        function saveBioDataInfo(crntTab) {
            ...
            for (var i = 0; i < totalFields; i++) {
                ...
                if ((selectElem && selectElem.hasAttribute('required') && selectElem.value == '') || (inputElem && inputElem
                        .hasAttribute('required') && inputElem.value == '') || (textareaElem && textareaElem.hasAttribute(
                        'required') && textareaElem.value == '')) {
                    toastr.error("Please fill up the required fields", "Failed to Save Info");
                    return false;
                }
            }
                    ...
                    success: function(result) {
                        ...
                        $.each(result, function(key, value) {
                            @if (App::currentLocale() == 'en')
                                $("#permenant_upazila_id").append('<option value="' +
                                    value.id +
                                    '" @if ($biodata && $biodata->permenant_upazila_id == "'+value.id+'") selected @endif>' +
                                    value.name + '</option>');
                            @else
                                $("#permenant_upazila_id").append('<option value="' +
                                    value.id +
            ...
            $('#present_district_id').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        $.each(result, function(key, value) {
                            @if (App::currentLocale() == 'en')
                                $("#present_upazila_id").append('<option value="' +
                                    value.id +
                                    '" @if ($biodata && $biodata->present_upazila_id == "'+value.id+'") selected @endif>' +
                                    value.name + '</option>');
                            @else
                                $("#present_upazila_id").append('<option value="' +
                                    value.id +
