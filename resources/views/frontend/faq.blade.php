            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-8 col-12">
                    <div class="breadcrumbs-content">
                        <h3 class="breadcrumbs-title">সচরাচর জিজ্ঞাসা সমূহ</h3>
                        ...
                        <div class="single-faq-widget">
                            <h2 class="accordion-header" id="headingOne">
                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                    ...
                                    <h3>সাদিকরুন ডটকম কী? এটি কিভাবে কাজ করে?</h3>
                                </button>
                            </h2>
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="faq-inner-body">
                                    <p class="faq-inner-body-text">
                                        এটি একটি বাংলাদেশী ইসলামিক ম্যাটরিমনি ওয়েবসাইট। এটির
                                        যাত্রা শুরু হয় জানুয়ারির ১ তারিখ ২০২১ । এখানে উপজেলা
                                        ভিত্তিক প্রেক্টিসিং মুসলিম পাত্রপাত্রীর বায়োডাটা খোঁজা ও
                                        অভিভাবকের সাথে যোগাযোগ করা যায়। একই সাথে পাত্র-পাত্রী
                                        চাইলে ওয়েবসাইটে বায়োডাটা তৈরি করে জমা দিতে পারে।
                                    </p>
                                </div>
                            </div>
                        </div>
